<template>
    <div class="real-days" :class="{ selected: isSelected, selecting: isSelecting }" :data-day="day"
        ...
        computed: {
            ...
            isSelected() {
                ...
                _.forEach(this.selected, (item) => {
                    if((item.day).toString() === (vm.dayKey).toString() && (item.hour).toString() === (vm.hour).toString() && item.selected === true){
                        exists = true;
                        return false;
                    }
                });
            ...
            isSelecting() {
                ...
                _.forEach(this.selecting, (item) => {
                    if((item.day).toString() === (vm.dayKey).toString() && (item.hour).toString() === (vm.hour).toString()){
                        exists = true;
                        return false;
                    }
                });
